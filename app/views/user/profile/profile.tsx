...
mountProtoPage(
  ...
  ({
    ...
    const backgroundUrl = useSignal<string | undefined>(initialBackgroundUrl)

    const description = useSignal<string | undefined>(initialDescription)
    const descriptionRich = useSignal(initialDescriptionRich)
    const socials = useSignal<readonly UserSocialValid[]>(initialSocials)
